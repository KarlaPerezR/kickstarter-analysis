...
<br/>Most of the successful works are related to small goal sizes (less than 5,000), while the works with the highest goals in the market (45,000 and up) have a high percentage greater than 88% of failures to succeed. must be in a range less than 5,000
